...
include('sidebar.php');
	...
	$login=$_SESSION['login'];
				...
				$q = $link ->query("select cordoni.* from cordoni ") or die(mysqli_error($link));
				$q2 = $link ->query("select schede.* from schede limit 3") or die(mysqli_error($link));
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Elenco Cordoni</h3>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				{
					$barcode = $r['barcode'];
					$nome_cord = $r['nome_cord'];
					$cognome_cord = $r['cognome_cord'];					
					$nome_madre = $r['nome_madre'];
					$cognome_madre = $r['cognome_madre'];
					$nascita_cord = $r['nascita_cord'];
					$ospedale= $r['ospedale'];
					$arrivo= $r['arrivo'];
				
				?>
				<tr>	
					<td ><a href="<?=$navigazione_http?>lavorazioni/hla_risultati.php?user=<?=$login?>&navigatore=1&sample=<?=$id?>"><?= $barcode ?></a></td>
					<td><?= $cognome_cord ?> - <?= $nome_cord ?></td>	
					<td><?= $cognome_madre ?> - <?= $nome_madre ?></td>	
					<td><?= $nascita_cord ?></td>	
					<td ><?= $ospedale ?></td>
					<td ><?= $arrivo ?></td>
				</tr>			
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Elenco Campioni</h3>
            ...
            <div class="box-body">
              <table id="Sample" class="table table-bordered table-striped">
				...
				{
					$nome = $r2['nome_d'];
					$id_famiglia = $r2['id_famiglia'];
					$barcode = $r2['barcode'];
					$id= $r2['id_campione'];
					$estrazione= $r2['estrazione'];
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td>prova provas prova </td>
                    <td><span class="label label-success">in arrivo </span></td>
            ...
            <div class="box-footer clearfix">
              <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Registra un nuovo Ordine</a>
